...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/web-computing/CreaArticolo">Lista Articoli</a>
          </li>
          <li class="nav-item">
  ...
  <article>
    <div class="container">
      <div class="row">
        <div class="card-body">
            <form action="<%=request.getContextPath()+"/CreaArticolo?action=3" %>" method="post">          
...
function initMap() {
  ...
  var marker = new google.maps.Marker({position: uluru, map: map});
    ...
    * The callback parameter executes the initMap() function
    -->
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA_TSQLF_hkX21EQQfrdoAxUPG9jhH-OP0&callback=initMap">
    </script>
    </div>
  </article>
